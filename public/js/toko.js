...
// =================================================================================
// LOGIKA INTI APLIKASI (RENDER, FILTER, MODAL OPSI)
// =================================================================================

/**
 * Fungsi baru sebagai pusat logika saat tombol "Beli" diklik.
 * Akan memeriksa apakah produk punya varian atau tidak.
 */
...
/**
 * Fungsi render produk di halaman toko.
...
/**
 * Fungsi validasi pembelian yang menampilkan modal kontak akhir.
 * Fungsi ini tidak diubah dari versi sebelumnya.
 */
...
// Fungsi-fungsi lain yang sudah ada di file Anda
